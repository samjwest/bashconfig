...
complete -c cryptsetup -l skip -s p --description 'How many sectors of the encrypted data to skip at the beginning.'
...
complete -c cryptsetup -l 'test-passphrase].' --description '.'
complete -c cryptsetup -l 'tcrypt-system].' --description '.'
