...
complete -c git-pull -l depth --description 'Deepen or shorten the history of a shallow repository created by git clone wi…'
...
complete -c git-pull -l preserve-merges --description 'along to git rebase so that locally created merge commits will not be flatten…'
