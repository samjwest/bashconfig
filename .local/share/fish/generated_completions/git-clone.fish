...
complete -c git-clone -l no-hardlinks --description 'Optimize the cloning process from a repository on a local filesystem by copyi…'
...
complete -c git-clone -l depth --description 'Create a shallow clone with a history truncated to the specified number of re…'
