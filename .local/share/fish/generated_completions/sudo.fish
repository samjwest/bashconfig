...
complete -c sudo -s A --description 'Normally, if sudo sudo requires a password, it will read it from the user\'s t…'
...
complete -c sudo -s V --description 'Print the sudo sudo version string as well as the version string of the secur…'
