...
complete -c s_client -o ssl2 -o ssl3 -o tls1 -o no_ssl2 -o no_ssl3 -o no_tls1 -o no_tls1_1 -o no_tls1_2 --description 'these options disable the use of certain \\s-1SSL\\s0 or \\s-1TLS\\s0 protocols.'
