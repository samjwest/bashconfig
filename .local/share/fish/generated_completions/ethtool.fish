...
complete -c ethtool -s G -l set-ring --description 'Changes the rx/tx ring parameters of the specified network device.'
...
complete -c ethtool -s N -s U -l config-nfc -l config-ntuple --description 'Configures receive network flow classification options or rules.'
...
complete -c ethtool -s L -l set-channels --description 'Changes the numbers of channels of the specified network device.'
