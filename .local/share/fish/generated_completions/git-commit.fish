...
complete -c git-commit -s o -l only --description 'Make a commit only from the paths specified on the command line, disregarding…'
...
complete -c git-commit -s S -l gpg-sign --description 'GPG-sign commit.'
