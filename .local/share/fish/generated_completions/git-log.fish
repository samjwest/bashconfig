...
complete -c git-log -s L -s L --description 'Trace the evolution of the line range given by "<start>,<end>" (or the funcna…'
...
complete -c git-log -l objects --description 'Print the object IDs of any object referenced by the listed commits.'
complete -c git-log -l objects-edge --description 'Similar to --objects, but also print the IDs of excluded commits prefixed wit…'
complete -c git-log -l unpacked --description 'Only useful with --objects; print the object IDs that are not in packs.'
