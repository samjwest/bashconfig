...
complete -c sysctl -s o --description 'Does nothing in favour of BSD compatibility.'
complete -c sysctl -s x --description 'Does nothing in favour of BSD compatibility.'
