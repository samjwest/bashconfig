...
complete -c find -o regextype --description 'the options affect all tests, including tests specified before the option.'
...
complete -c find -o depth --description 'Process each directory\'s contents before the directory itself.   The.'
...
complete -c find -o path --description 'Braces are not recognised as being special, despite the fact that some shells…'
...
complete -c find -o size --description 'File uses n units of space.   The following suffixes  can be used:.'
