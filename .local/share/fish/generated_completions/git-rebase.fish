...
complete -c git-rebase -s f -l force-rebase --description 'Force the rebase even if the current branch is a descendant of the commit you…'
complete -c git-rebase -l fork-point -l no-fork-point --description 'Use git merge-base --fork-point to find a better common ancestor between upst…'
...
complete -c git-rebase -l autostash --description 'Automatically create a temporary stash before the operation begins, and apply…'
