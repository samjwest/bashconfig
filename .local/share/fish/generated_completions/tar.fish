...
complete -c tar -o '\\-atime\\-preserve' --description 'preserve access times on dumped files, either by restoring the times.'
...
complete -c tar -o '\\-occurrence' --description 'process only the NUMBERth occurrence of each file in the archive;.'
...
complete -c tar -s s --description 'member arguments are listed in the same order as the.'
