...
complete -c git-rev-list -l notes --description 'Show the notes (see git-notes(1)) that annotate the commit, when showing the …'
complete -c git-rev-list -l no-notes --description 'Do not show notes.'
complete -c git-rev-list -l show-notes -l standard-notes --description 'These options are deprecated.'
