...
complete -c git-am -s 3 -l 3way --description 'When the patch does not apply cleanly, fall back on 3-way merge if the patch …'
complete -c git-am -l ignore-date -l ignore-space-change -l ignore-whitespace -l whitespace -o 'C<n>' -o 'p<n>' -l directory -l exclude -l include -l reject --description 'These flags are passed to the git apply (see git-apply(1)) program that appli…'
